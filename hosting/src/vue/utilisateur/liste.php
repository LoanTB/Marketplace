...
foreach ($utilisateurs as $utilisateur) {
    echo '<p> Client ' . htmlspecialchars($utilisateur->getprenom()) . ' ' . htmlspecialchars($utilisateur->getnom()) . ' de login <a href="controleurFrontal.php?controleur=utilisateur&action=afficherDetail&login=' . rawurlencode($utilisateur->getlogin()) . '">' . htmlspecialchars($utilisateur->getlogin()) . '<a>.';
