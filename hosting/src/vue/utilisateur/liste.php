...
foreach ($utilisateurs as $utilisateur) {
    ...
    if (ConnexionUtilisateur::estUtilisateur($utilisateur->getlogin()) or ConnexionUtilisateur::estAdministrateur()) {
        echo ' (<a href="controleurFrontal.php?controleur=utilisateur&action=afficherFormulaireMiseAJour&login=' . htmlspecialchars(rawurlencode($utilisateur->getlogin())) . '">modifier</a><a href="controleurFrontal.php?controleur=utilisateur&action=supprimer&login=' . htmlspecialchars(rawurlencode($utilisateur->getlogin())) . '">supprimer</a>)</p>';
    } else {
        echo '</p>';
    }
}
