    ...
    <nav>
        <ul>
            ...
            if (ConnexionUtilisateur::estConnecte()){
                echo '<li><a href="controleurFrontal.php?action=afficherDetail&controleur=utilisateur&login='.ConnexionUtilisateur::getLoginUtilisateurConnecte().'"><img src="./../ressources/img/user.png" alt="infos utilisateur"></a></li>';
